...
| :----:|:----:| :-----:|
| 11.11 | 1    | Tein Book Tracker sovellukselle vaatimusmäärittelyn |
| 18.11 | 5    | Tein sovellukeen rekisteröitymisen & kirjautumisen, changelogin, invoket |
| 18.11 | 1    | Päivitin README.md ja changelogin |
| 25.11 | 2    | Latasin pylintin ja autopep8. Ajoin molemmat ja tein tarvittavat korjaukset. Päivitin dokumentaation dokumentit. Lisäsin arkkitehtuuri.md ja lisäsin sovelluslogiikan kaavion sinne. |
| 1.12  | 3    | Aloin rakentamaan toiminnallisuutta uusien kirjojen lisäämiselle |
...
| 20.12 | 12 | Uusi UI pushattu. Käyttäjä voi nähdä luettujen kirjojen sivumäärän sivuina tai prosentteina. Käyttäjä voi etsiä kirjoja search barin avulla kirjoittamalla kirjailijan tai kirjan nimen. Käyttäjä voi tarkastella lukemansa ja lukemattomat sivut pylväsdiagrammissa matplotlib-kirjaston avulla. Luotu testausdokumentti, päivitetty kaikki dokumentit ajantasalle. Luotu "loppupalautus" release. Vastattu kielimalli kyselyyn ja käyty antamassa palaute. |
| Yht.  | 53   | |
