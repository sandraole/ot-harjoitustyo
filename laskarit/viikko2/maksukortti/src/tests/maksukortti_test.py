...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_kortilla_voi_ostaa_edullisen_lounaan_kun_siellä_on_annoksen_tarkka_hinta(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_kortilla_voi_ostaa_maukkaan_lounaan_kun_siellä_on_annoksen_tarkka_hinta(self):
