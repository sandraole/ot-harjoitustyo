...
class UI:
    ...
    def _show_login_view(self):
        ...
        tk.Label(self._frame, text="Login", font=("Arial", 16), bg="#3498db", fg="white").pack(pady=10)
        ...
        ttk.Button(self._frame, text="Sign In", command=lambda: self._sign_in(username_entry.get(), password_entry.get())).pack(pady=5)
        ttk.Button(self._frame, text="Register", command=self._show_register_view).pack()
